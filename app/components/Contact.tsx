const Contact = () => {
  return (
    ...
    >
      <div className=" shadow-lg  md:px-5 px-8 pt-18 flex flex-col mx-auto  lg:w-2/3 ">
        <h1 className="text-2xl font-semibold mx-auto bg-gradient-text bg-clip-text text-transparent title-font mb-4 text-gray-900">
          Get in Touch
        </h1>
